...
declare_id!("21FD2tKF2nG8TWdeQkm1PA5svKeE5fyqEtUPxg4khAsM");
...
pub mod refinance_router {
    ...
    pub fn initiate_refinance(
        ...
        instructions::initiate_refinance::handler(
            ctx,
            source_protocol,
            target_protocol,
            collateral_amount,
